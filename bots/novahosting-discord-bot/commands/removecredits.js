...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription("Remove credits from a customer's account")
    .addUserOption((opt) =>
      opt.setName("user").setDescription("The Discord user to debit").setRequired(true),
    )
    .addNumberOption((opt) =>
      opt
        .setName("amount")
    ...
    await interaction.editReply({
      embeds: [
        successEmbed({
          ...
          description: `Removed **${amount}** credits from ${target}'s account.`,
        }),
      ],
    });
